...
module.exports.run = async (client, message, args, level, Discord) => {
  switch (args[0] && args[0].toLowerCase()) {
    ...
    case 'tn': {
      ...
      client.users.set(message.author.id, name, 'island.islandName');
    ...
    case 'f': {
      ...
      client.users.set(message.author.id, fruit, 'island.fruit');
    ...
    case 'islandername': {
      ...
      client.users.set(message.author.id, name, 'island.characterName');
    ...
    case 'hemi': {
      ...
      client.users.set(message.author.id, hemisphere, 'island.hemisphere');
    ...
    case 'sn': {
      ...
      client.users.set(message.author.id, name, 'island.profileName');
    ...
    case 'code': {
      ...
      client.users.set(message.author.id, code, 'friendcode');
    ...
    case 'mod': {
      ...
      switch ((args[0].toLowerCase() === 'mod' && level >= 3) ? args[2].toLowerCase() : args[1].toLowerCase()) {
        ...
        case 'townname':
        case 'tn':
          client.users.set(memberID, '', 'island.islandName');
        ...
        case 'fr':
        case 'f':
          client.users.set(memberID, '', 'island.fruit');
        ...
        case 'vn':
        case 'islandername':
          client.users.set(memberID, '', 'island.characterName');
        ...
        case 'hm':
        case 'hemi':
          client.users.set(memberID, '', 'island.hemisphere');
        ...
        case 'switchname':
        case 'sn':
          client.users.set(memberID, '', 'island.profileName');
        ...
        case 'fc':
        case 'code':
          if (client.users.has(memberID, 'friendcode')) {
            client.users.delete(memberID, 'friendcode');
    ...
    default: {
      ...
      const { friendcode, island } = client.users.ensure(member.id, client.config.usersDefaults);
