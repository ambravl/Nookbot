client.exports.run = (client, message, args) => {
  ...
  } else if (command.help.category === 'system') return client.error(message.channel, 'Forbidden', "You can't disable this command!");
  else {
